...
- Including another person's note content, identifiers, account information, or
  local paths in a public report without permission.
...
reported to the maintainer through the private contact method currently listed
on the [nextgencods GitHub profile](https://github.com/nextgencods). If no private
method is listed, open a neutral issue asking for a private moderation channel
